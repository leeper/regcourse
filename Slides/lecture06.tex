...
\frame{
	\frametitle{Changes in Slope and Level}
	\begin{itemize}\itemsep1em
	\item Discontinuities might produce changes in:\\
		\begin{itemize}
		\item Slope, \textit{and/or}
		\item Level/Intercept
		\end{itemize}
	\item 
	\end{itemize}
}
...
% curvilinear relationship that might appear to be RD
