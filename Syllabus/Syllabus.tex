...
\item Essay 2 due March 20 to Thomas % Something on interaction/data merging?
\item Essay 3 due April 17 to David % Something on multilevel?
\item Essay 4 due May 8 to Thomas % Something on panel GLM?
\end{enumerate*}
...
\clearpage
\subsection*{No class (Week 14)} % Easter


\clearpage
\subsection{Maximum Likelihood Estimation (Week 15)} % Easter Th Apr 2 - Mon Apr 6 (Meet in wk 14 if Mon/Tu class; otherwise meet in wk 15)
...
\clearpage
\subsection{Interpretation of GLMs (Week 17)}
...
\clearpage
\subsection{Panel Analysis for Discrete Outcomes (Week 20)}
...
\clearpage
\subsection{Conclusion and Wrap-up (Week 21 ?)} % May 13
