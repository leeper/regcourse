...
\textbook[Ch.2 from ]{Angrist and Pischke}
...
\textbook[Ch. 1--3 from ]{S{\o}nderskov}
...
\subsubsection*{Readings for lab}
\textbook[Ch. 10 from ]{S{\o}nderskov}
...
\subsubsection*{Readings for lab}
\textbook{Ch. 2 from }{Cameron and Trivedi}
...
\subsubsection*{Readings}
\textbook[Ch.4,6 from ]{Angrist and Pischke}
\reading{AcemogluJohnsonRobinson2001}
\reading{Carrubba2008}
...
\subsubsection*{Readings for lab}
\textbook[Ch. 6 from ]{Cameron and Trivedi}
...
\subsubsection*{Readings}                               % pages
\reading[(51--83; 91--130) from ]{Rabe-HeskethSkrondal2008}  % 73
...
\subsubsection*{Readings for lab}
\reading[(Review previous sections) from ]{Rabe-HeskethSkrondal2008}
\textbook[(56--58; 305--316) from ]{Cameron and Trivedi}
...
\subsubsection*{Readings for lab}                             % pages
\reading[Ch.3--4 (skim sections on probit) from ]{LongFreese2005}  % 108
...
\subsection*{Lecture}
\begin{itemize*}
\item Logit versus Probit % or maybe this will be covered in previous week
...
\textbook[Ch.14 from ]{Cameron and Trivedi}
...
\subsubsection*{Readings}      % pages
\textbook[Ch.5,6,8 from ]{Long}  % 107
...
\subsubsection*{Readings for lab}    % pages
\reading[Ch.5,6,8 from ]{LongFreese2005}  % 171
...
\reading[Ch.3,4,8 from ]{Box-SteffensmeierJones2004}  % 70
...
\subsubsection*{Readings for lab}                                            % pages
\reading[(47--77, 129--144, 203--211, 245--268) from ]{ClevesGouldGutierrez2003}  % 80
...
\subsubsection*{Readings}
\textbook[Ch.3,4 from ]{Allison}
\textbook[pp.615--641 from ]{Cameron and Trivedi}
...
\reading[Ch.17.4 from ]{Greene2012}
